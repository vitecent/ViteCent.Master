...
using Quartz;
using Template.Core;
using Template.Core.Cache;
using Template.Core.Data;
using Template.Core.Register;

#endregion

namespace Template.Job.Api.Jobs;
...
public class HomeJob : IJob
{
    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        logger.LogInformation($"{DateTime.Now:yyyy-MM-dd HH:mm:ss}获取到{services.Count}个 服务");
