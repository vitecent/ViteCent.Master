...
using Quartz;
using Template.Core.Api.Swagger;
using Template.Core.Cache.Redis;
using Template.Core.Job.Quartz;
using Template.Core.Orm.SqlSugar;
using Template.Core.Register.Consul;
using Template.Core.Trace.Zipkin;
