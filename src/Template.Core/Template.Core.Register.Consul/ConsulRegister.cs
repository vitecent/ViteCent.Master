...
namespace Template.Core.Register.Consul;

/// <summary>
///     Class ConsulRegister. Implements the <see cref="Template.Core.Register.IRegister" />
/// </summary>
/// <seealso cref="Template.Core.Register.IRegister" />
