...
namespace YPHF.Core.Web
{
    ...
    public class BaseCookie(HttpContext context)
    {
        /// <summary>
        /// </summary>
        public void ClearCookie() => context.Request.Cookies.Keys.ToList().ForEach(x => ClearCookie(x));

        /// <summary>
        /// </summary>
        /// <param name="key"></param>
        public void ClearCookie(string key) => context.Response.Cookies.Delete(key);
        ...
        public void SetCookie(string key, string vlaue) => SetCookie(key, vlaue, default);
