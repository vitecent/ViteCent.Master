...
namespace YPHF.Core
{
    ...
    public static partial class BaseRegex
    {
        ...
        public static bool IsChinese(this string str) => Chinese().IsMatch(str);
        ...
        public static bool IsChineseEnglish(this string str) => ChineseEnglish().IsMatch(str);
        ...
        /// </returns>
        public static bool IsChineseUnderline(this string str) => ChineseUnderline().IsMatch(str);
        ...
        public static bool IsDecimal(this string str, int length = 2) => Regex.IsMatch(str, string.Format(Const.Decimal, length));
        ...
        public static bool IsEmail(this string str) => Email().IsMatch(str);
        ...
        public static bool IsEnglish(this string str) => English().IsMatch(str);
        ...
        public static bool IsIP(this string str) => IP().IsMatch(str);
        ...
        public static bool IsMatch(this string str, string regex) => Regex.IsMatch(str, regex);
        ...
        public static bool IsMobile(this string str) => Mobile().IsMatch(str);
        ...
        public static bool IsNegative(this string str) => Negative().IsMatch(str);
        ...
        /// </returns>
        public static bool IsNegativeDecimal(this string str, int length = 2) => Regex.IsMatch(str, string.Format(Const.NegativeDecimal, length));
        ...
        /// </returns>
        public static bool IsNegativeDecimalDecimal(this string str, int length = 2) => Regex.IsMatch(str, string.Format(Const.NegativeDecimalDecimal, length));
        ...
        public static bool IsPositive(this string str) => Positive().IsMatch(str);
        ...
        /// </returns>
        public static bool IsPositiveChinese(this string str) => PositiveChinese().IsMatch(str);
        ...
        /// </returns>
        public static bool IsPositiveChineseEnglish(this string str) => PositiveChineseEnglish().IsMatch(str);
        ...
        /// otherwise, <c>false</c>.
        /// </returns>
        public static bool IsPositiveChineseEnglishUnderline(this string str) => PositiveChineseEnglishUnderline().IsMatch(str);
        ...
        /// </returns>
        public static bool IsPositiveChineseUnderline(this string str) => PositiveChineseUnderline().IsMatch(str);
        ...
        /// </returns>
        public static bool IsPositiveDecimal(this string str, int length = 2) => Regex.IsMatch(str, string.Format(Const.PositiveDecimal, length));
        ...
        /// </returns>
        public static bool IsPositiveEnglish(this string str) => PositiveEnglish().IsMatch(str);
        ...
        /// </returns>
        public static bool IsPositiveEnglishUnderline(this string str) => PositiveEnglishUnderline().IsMatch(str);
        ...
        /// </returns>
        public static bool IsPositiveNegative(this string str) => PositiveNegative().IsMatch(str);
        ...
        /// </returns>
        public static bool IsPositiveUnderline(this string str) => PositiveUnderline().IsMatch(str);
        ...
        public static bool IsUrl(this string str) => Url().IsMatch(str);
        ...
        public static bool Underline(this string str) => EnglishUnderline().IsMatch(str);
