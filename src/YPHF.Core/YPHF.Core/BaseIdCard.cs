...
namespace YPHF.Core
{
    ...
    public static class IdCardHelper
    {
        ...
        /// <param name="str">The string.</param>
        /// <returns>System.String.</returns>
        public static string GetIdCardBirthday15(this string str) => str.Substring(6, 6).Insert(4, "-").Insert(2, "-");
        ...
        /// <param name="str">The string.</param>
        /// <returns>System.String.</returns>
        public static string GetIdCardBirthday18(this string str) => str.Substring(6, 8).Insert(6, "-").Insert(4, "-");
        ...
        public static bool IsIdCard15(this string str)
        {
            ...
            if (!address.Contains(str.Remove(2), StringComparison.CurrentCulture))
            {
                return false;
            }
        ...
        {
            //数字验证
            if (long.TryParse(str.Remove(17), out long x) == false || x < Math.Pow(10, 16) || long.TryParse(str.Replace('x', '0').Replace('X', '0'), out _) == false)
            {
                return false;
            }
            ...
            if (!arrVarifyCode[y].Equals(str.Substring(17, 1), StringComparison.CurrentCultureIgnoreCase))
            {
                return false;
            }
