...
namespace YPHF.Core
{
    ...
    public static class BaseString
    {
        ...
        public static Stream ByteToStream(this byte[] buffer) => buffer.ByteToStream(Encoding.Default);
        ...
        public static string ByteToString(this byte[] buffer) => buffer.ByteToString(Encoding.Default);
        ...
        /// <returns>System.String.</returns>
        /// <exception cref="System.Exception">str</exception>
        /// <exception cref="System.Exception">hide</exception>
        /// <exception cref="System.Exception">length</exception>
        public static string HideString(this string str, HideEnum hide, int length)
        {
            ...
            if (length < 0)
            {
                throw new Exception("length 格式错误");
            }
        ...
        /// <param name="stream">The stream.</param>
        /// <returns>System.String.</returns>
        public static string StreamToString(this Stream stream) => stream.StreamToString(Encoding.Default);
        ...
        /// <param name="str">The string.</param>
        /// <returns>System.Byte[].</returns>
        public static byte[] StringToByte(this string str) => str.StringToByte(Encoding.Default);
        ...
        /// <param name="str">The string.</param>
        /// <returns>Stream.</returns>
        public static Stream StringToStream(this string str) => str.StringToStream(Encoding.Default);
        ...
        /// <returns>System.String.</returns>
        /// <exception cref="System.Exception">str</exception>
        /// <exception cref="System.Exception">split</exception>
        private static string ToCamelCase(this string str, string split)
        {
            ...
            {
                throw new Exception("split 不能为空");
            }
